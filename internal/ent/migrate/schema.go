...
var (
	...
	HelpsColumns = []*schema.Column{
		...
		{Name: "latitude", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "longitude", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "numeric"}},
